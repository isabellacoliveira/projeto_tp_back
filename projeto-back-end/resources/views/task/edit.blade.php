@extends('base')
@section('conteudo')
<form action="/tasks/{{$objetoTask->id}}" method="post">
    @method('put')
    @csrf
    ...
    <p>
        ...
        <input type="hidden" name="completed" value="0"> <!-- Garante que um valor será enviado mesmo se o checkbox não estiver marcado -->
    </p>
